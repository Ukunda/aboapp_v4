  ...
  static ThemeData get lightTheme {
    return ThemeData(
      ...
      inputDecorationTheme: InputDecorationTheme(
        filled: true,
        fillColor:
            const Color(0x80FFFFFF), // AppColors.surfaceLight.withOpacity(0.5)
        contentPadding:
        ...
        hintStyle: AppTypography.bodyMedium.copyWith(
            color: AppColors.onSurfaceVariantLight
                .withOpacity(0.7)), // Kept withOpacity as it's not const
        floatingLabelStyle:
  ...
  static ThemeData get darkTheme {
    return ThemeData(
      ...
      inputDecorationTheme: InputDecorationTheme(
        filled: true,
        fillColor:
            const Color(0x801F2937), // AppColors.surfaceDark.withOpacity(0.5)
        contentPadding:
            const EdgeInsets.symmetric(horizontal: 16, vertical: 14),
        border: OutlineInputBorder(
          borderRadius: BorderRadius.circular(12.0),
        ...
        hintStyle: AppTypography.bodyMedium.copyWith(
            color: AppColors.onSurfaceVariantDark
                .withOpacity(0.7)), // Kept withOpacity
        floatingLabelStyle:
